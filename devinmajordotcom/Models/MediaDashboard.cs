...
//     Connection String Name: "MediaConnection"
//     Connection String:      "Data Source=.\DEVINSSQLEXPRESS;Initial Catalog=MediaDashboard;Integrated Security=True"
// ------------------------------------------------------------------------------------------------
...
namespace devinmajordotcom.Models
{
    ...
    public class SiteLink
    {
        ...
        public bool IsAdminLink { get; set; } // IsAdminLink
    ...
    public class SiteLinkConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SiteLink>
    {
        ...
        public SiteLinkConfiguration(string schema)
        {
            ...
            Property(x => x.Url).HasColumnName(@"URL").HasColumnType("nvarchar").IsRequired().HasMaxLength(500);
